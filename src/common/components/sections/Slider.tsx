...
export default function Slider() {
  return (
    <section id='journal-slider' className='relative bg-[url("/images/slide.png")] bg-cover bg-center bg-no-repeat'>
      <div className='px-4 sm:px-10 lg:container lg:mx-auto lg:px-0'>
        <div className='my-32.5 flex w-full flex-col items-center justify-center gap-4 text-center lg:max-w-99.5 lg:items-start lg:justify-baseline lg:text-start'>
          ...
          <p className='text-foreground max-w-80 text-sm/relaxed 2xl:text-lg/relaxed'>
          ...
          <div className='mt-5 max-w-52'>
            <NavigateButton content='Dergiyi Görüntüle' variant='solid' />
          </div>
        </div>
      </div>
    </section>
